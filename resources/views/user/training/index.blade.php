...
<div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm ring-1 ring-gray-900/5 dark:ring-slate-700 p-8">
    <div class="border-b border-gray-200 pb-4 mb-6">
        <h3 class="text-lg font-bold leading-6 text-gray-900 dark:text-white">Form Pendaftaran Pelatihan</h3>
    ...
    <form action="{{ route('user.pendaftaran.store') }}" method="POST">
        ...
        <div class="mb-5">
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Pilih Program Pelatihan</label>
        ...
        <div class="mb-8">
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Mentor Pendamping</label>
